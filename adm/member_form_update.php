...
$mb_tel = isset($_POST['mb_tel']) ? trim(strip_tags($_POST['mb_tel'])) : '';
...
$mb_2 = isset($_POST['mb_2']) ? $_POST['mb_2'] : array();
$mb_2_str = implode(',', $mb_2);
...
$sql_common = "  mb_name = '{$posts['mb_name']}',
                 ...
                 mb_1 = '{$posts['mb_1']}',
                 mb_2 ='".sql_real_escape_string($mb_2_str)."',
                 mb_3 = '{$posts['mb_3']}',
                 mb_4 = '{$posts['mb_4']}',
                 mb_5 = '{$posts['mb_5']}',
                 mb_6 = '{$posts['mb_6']}',
                 ...
                 mb_edate = '{$posts['mb_edate']}',
                 mb_doctor = '{$posts['mb_doctor']}' 
                 ";
