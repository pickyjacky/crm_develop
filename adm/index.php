...
// 원장님이 접속 시 해당 URL로 이동
if ($member['mb_id'] == 'boss') {
    header('Location: https://chart.oneup-creative.kr/adm/member_list.php');
    exit;
}
...
<section>
    <!-- <h2>신규회원 <?php echo $new_member_rows ?>건</h2> -->
    <h2>총회원수 <?php echo number_format($total_count) ?>명</h2>
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <td class="td_mbsex"><?php echo $row['mb_8'] ?></td>
            <td class="td_mbtel"><div><?php echo get_text($row['mb_hp']); ?></div></td>
