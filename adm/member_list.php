...
<select name="sfl" id="sfl">
    <option value="mb_id"<?php echo get_selected($sfl, "mb_id"); ?>>차트번호</option>
    <option value="mb_name"<?php echo get_selected($sfl, "mb_name"); ?>>이름</option>
    <option value="mb_tel"<?php echo get_selected($sfl, "mb_tel"); ?>>본인번호</option>
</select>
...
<div class="local_desc01 local_desc">
    <p>
        회원 중복 추가를 방지하기 위해 삭제가 불가능합니다. 삭제 원할 시 원업으로 문의 해주세요.
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" id="mb_list_id" colspan="2"><?php echo subject_sort_link('mb_id') ?>차트번호</a></th>
        <th scope="col" id="mb_list_name"><?php echo subject_sort_link('mb_name') ?>이름</a></th>
        <th scope="col" id="mb_list_sex">성별</th>
        <th scope="col" id="mb_list_mobile">본인번호</th>
        <th scope="col" id="mb_list_tel">보호자번호</th>
        <th scope="col" id="mb_list_doctor">담당의료진</th>
        <th scope="col" id="mb_list_case">CASE</th>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <!-- 성별 -->
        <td headers="mb_list_sex" class="td_mbsex"><?php echo get_text($row['mb_8']); ?></td>
        <!-- 본인번호 -->
        <td headers="mb_list_mobile" class="td_tel"><?php echo get_text($row['mb_hp']); ?></td>
        <!-- 보호자번호 -->
        <td headers="mb_list_tel" class="td_tel"><?php echo get_text($row['mb_tel']); ?></td>
        <!-- 담당의료진 -->
        <td headers="mb_list_doctor" class="td_doctor"><?php echo get_text($row['mb_doctor']); ?></td>
        <!-- CASE -->
        <td headers="mb_list_case" class="td_case"><?php echo get_text($row['mb_case']); ?></td>
        <!-- 관리 -->
